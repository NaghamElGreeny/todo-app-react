...
const ToDoList = () => {
  ...
  return (
    <section className="bg-green-400/20 rounded-3xl p-4 shadow-md w-full max-w-2xl mx-auto min-h-full flex flex-col">
      <TaskInput onAdd={handleAddTask} />
      <div className="flex-1 overflow-y-auto mt-1 pr-1 custom-scroll">
        <TaskList
          tasks={tasks}
